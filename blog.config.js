...
const BLOG = {
  AUTHOR: 'WhistleO', // 作者
  BIO: 'WhistleO’s Blog', // 作者简介
  LINK: 'https://whistleo.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'e1f37e02d21046cdabee1fca5721babe', // page id
  ...
  CONTACT_EMAIL: 'WhistleO@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/WhistleO',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'WhistleO\'s BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
